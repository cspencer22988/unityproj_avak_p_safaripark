Shader "LKWD/Opaque/VertexMaskedBlend2" {
	Properties {
		...
		Pass {
			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					{
					  lowp vec4 tmpvar_1;
					  tmpvar_1 = mix (texture2D (_MainTex, xlv_TEXCOORD0), texture2D (_Texture2, xlv_TEXCOORD1), vec4(clamp ((
					    (((xlv_TEXCOORD4.x * texture2D (_Mask, xlv_TEXCOORD2).x) + xlv_TEXCOORD4.x) * 2.0)
					   - 1.0), 0.0, 1.0)));
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  lowp vec4 final_1;
					  lowp vec4 tmpvar_2;
					  tmpvar_2 = mix (texture2D (_MainTex, xlv_TEXCOORD0), texture2D (_Texture2, xlv_TEXCOORD1), vec4(clamp ((
					    (((xlv_TEXCOORD4.x * texture2D (_Mask, xlv_TEXCOORD2).x) + xlv_TEXCOORD4.x) * 2.0)
					   - 1.0), 0.0, 1.0)));
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD3 = vec2(0.0, 0.0);
					  xlv_TEXCOORD4 = tmpvar_2;
					  xlv_TEXCOORD5 = exp2(-((unity_FogParams.y * tmpvar_3.z)));
					}
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  lowp vec4 final_2;
					  lowp vec4 tmpvar_3;
					  tmpvar_3 = mix (texture2D (_MainTex, xlv_TEXCOORD0), texture2D (_Texture2, xlv_TEXCOORD1), vec4(clamp ((
					    (((xlv_TEXCOORD4.x * texture2D (_Mask, xlv_TEXCOORD2).x) + xlv_TEXCOORD4.x) * 2.0)
					   - 1.0), 0.0, 1.0)));
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD4 = tmpvar_2;
					  xlv_TEXCOORD5 = ((_glesMultiTexCoord1.xy * unity_LightmapST.xy) + unity_LightmapST.zw);
					  xlv_TEXCOORD6 = exp2((-(tmpvar_5) * tmpvar_5));
					}
